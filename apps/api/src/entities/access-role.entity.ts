...
export class AccessRole {
  ...
  @Column({ name: 'base_role', type: 'varchar', length: 32 }) baseRole!: UserRole;
  @Column({ name: 'system_key', type: 'varchar', length: 32, nullable: true, unique: true }) systemKey!: UserRole | null;
