...
export function RoutesPage() {
  ...
  const candidates = useMemo(() => tasks.filter((task) => !['COMPLETED', 'VERIFIED'].includes(task.status) && (!brigadeId || !task.brigadeId || task.brigadeId === Number(brigadeId))), [tasks, brigadeId])
